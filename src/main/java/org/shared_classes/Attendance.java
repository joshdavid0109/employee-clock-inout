...
public interface Attendance extends Remote {
    int logIn(String username, String password) throws RemoteException, CredentialsErrorException;
    ...
    EmployeeProfile getEmployeeProfileFromUserName(String username)throws RemoteException;
}
